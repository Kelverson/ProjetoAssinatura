...
if(repost != True):
    ...
    for account in accounts:
        ...
        #email = accounts.DisplayName.split('@')[1]
        #print('teste',email)
        ...
        for email in emails :
            ...
            try:
                ...
                diretorio = os.path.join(rf'C:\Users\{username}\AppData\Roaming\Microsoft\Signatures')
                caminho = os.path.join(diretorio, f'teste ({email}).htm')
